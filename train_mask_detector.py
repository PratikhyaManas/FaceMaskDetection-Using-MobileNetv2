...
DIRECTORY = r"D:\PyCharm\Face-Mask-Detection\dataset"
...
# the base model
final_Model = baseModel.output
final_Model = AveragePooling2D(pool_size=(7, 7))(final_Model)
...
model = Model(inputs=baseModel.input, outputs=final_Model)
